...
//          std::string anchor_locs[] = {"0,0","3600,0","3600,3100","0,3100"};
          std::string anchor_locs[] = {"0,0","0,4488","12072,4488","12072,0"};

          std::string ids = anchor_locs[currentDeviceIndex];
          std::string tdoas = std::to_string((int)num_nodes)+",";
          for(int i=0;i<response_counter;i++)
          {
            ...
            for(int j=0;j<num_nodes;j++)
            {
              ...
              {
//                Serial.println("thisRange[i].device_ID: ");
...
//                Serial.println(j);
                ...
                tdoas = tdoas+std::to_string((int)thisRange[i].device_ID)+","+std::to_string((int)(T_AB_minus_rAB+ToA_mat[thisRange[i].device_ID][currentDeviceIndex]))+",";
...
//          Serial.println("id:");
//          Serial.print(ids.c_str());
//          Serial.println("tdoas:");
//          Serial.print(tdoas.c_str());
          std::string output = tdoas;
          char buff[200];
